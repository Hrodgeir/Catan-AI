...
class Display(tk.Frame):
    def __init__(self, board_states, players, has_won, winner):
        # Initialize the GUI
        self.master = tk.Tk()
        ...
        self.initialize_board(board_states, players, has_won, winner)
    ...
    def initialize_board(self, board_states, players, has_won, winner):
        """
